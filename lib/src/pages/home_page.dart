...
import 'package:qr_scanner_generator/src/bloc/scans_bloc.dart';
import 'package:qr_scanner_generator/src/models/scan_model.dart';
import 'package:qr_scanner_generator/src/pages/emails_page.dart';
import 'package:qr_scanner_generator/src/pages/generate.dart';
import 'package:qr_scanner_generator/src/pages/telefonos_page.dart';
//Utilidades
import 'package:qr_scanner_generator/src/utils/utils.dart' as utils;
            ...
            onPressed: () => showDialog(
                ...
                builder: (context) {
                  return AlertDialog(
                    ...
                    content: const Text(
                        'Al aceptar se borraran todos los Qr Scans de la App'),
                    actions: <Widget>[
                      FlatButton(
                        onPressed: scansBloc.borrarScansTodos,
